...
(function(window, document, undefined) {
    ...
    L.DomUtil = {
        ...
        getTranslateString: function(point, rotate) {
            // on WebKit browsers (Chrome/Safari/iOS Safari/Android) using translate3d instead of translate
            // makes animation smoother as it ensures HW accel is used. Firefox 13 doesn't care
            // (same speed either way), Opera 12 doesn't support translate3d

            var rotate = (typeof rotate === 'undefined') ? 'rotate(0deg)' : rotate;
            ...
            if (rotate)
                return open + point.x + 'px,' + point.y + 'px' + close + rotate;
            else
        ...
        setPosition: function(el, point, disable3D) { // (HTMLElement, Point[, Boolean])
            ...
            if (!disable3D && L.Browser.any3d) {
                el.rotate = el.style[L.DomUtil.TRANSFORM].match(/rotate\(\d+deg\)/g);
                el.style[L.DomUtil.TRANSFORM] = L.DomUtil.getTranslateString(point, el.rotate);
            } else {
