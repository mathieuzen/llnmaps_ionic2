            ...
            (function (global) {
                (function () {
                    ...
                    L.Routing.OSRM = L.Class.extend({
                        ...
                        buildMatchUrl: function (waypoint, serviceUrl) {
                            var locationKey = this._locationKey(waypoint);
                            var loc = 'loc=' + locationKey
                            return serviceUrl.replace("viaroute", "match") + '?' + loc + "&" + loc;
                        },
